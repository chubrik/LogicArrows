...
start_title:        ldi b, " "
                    ...
                    ldi c, start_title -1       ; Ссылка на последний символ строки с названием
                                                ...
                                                ; смещается к началу строки и одновременно работает
                                                ; как счётчик, по которому цикл завершается.
...
; Содержит изображение-заставку. В дальнейшем используется для вывода каждого кадра.
