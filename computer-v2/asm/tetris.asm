...
buffer_ptr      db  INI_BUFFER_PTR          ; Указатель на буфер. Если область фигуры спускается
                                            ;   ниже экрана дисплея, указатель смещается назад, как
                                            ;   бы уменьшая размер буфера. (0x00...0x07)
display_ptr     db  INI_DISPLAY_PTR         ; Указатель на конец области фигуры на дисплее. Если
                                            ;   область фигуры спускается ниже экрана дисплея,
                                            ;   указатель остаётся на месте, как бы уменьшая размер
                                            ;   области фигуры. (0x67...0x7F, всегда нечётный)
...
; Сохраняем указатель и адрес данных о следующем повороте фигуры
...
; Данные о каждом следующем состоянии поворота фигур. Фигура O отсутствует, т.к. её поворот
; невозможен. Для оптимизации ряды с пикселями фигур хранятся в обратном порядке.

turn_i0         db  turn_i1, 0b01000000, 0b01000000, 0b01000000, 0b01000000 ; Фигура I
turn_i1         db  turn_i0, 0b00000000, 0b00000000, 0b11110000, 0b00000000

turn_s0         db  turn_s1, 0b00000000, 0b00100000, 0b01100000, 0b01000000 ; Фигура S
turn_s1         db  turn_s0, 0b00000000, 0b00000000, 0b11000000, 0b01100000

turn_z0         db  turn_z1, 0b00000000, 0b01000000, 0b01100000, 0b00100000 ; Фигура Z
turn_z1         db  turn_z0, 0b00000000, 0b00000000, 0b01100000, 0b11000000

turn_t0         db  turn_t1, 0b00000000, 0b01000000, 0b01100000, 0b01000000 ; Фигура T
turn_t1         db  turn_t2, 0b00000000, 0b01000000, 0b11100000, 0b00000000
turn_t2         db  turn_t3, 0b00000000, 0b01000000, 0b11000000, 0b01000000
turn_t3         db  turn_t0, 0b00000000, 0b00000000, 0b11100000, 0b01000000

turn_j0         db  turn_j1, 0b00000000, 0b01000000, 0b01000000, 0b01100000 ; Фигура J
turn_j1         db  turn_j2, 0b00000000, 0b00000000, 0b00100000, 0b11100000
turn_j2         db  turn_j3, 0b00000000, 0b01100000, 0b00100000, 0b00100000
turn_j3         db  turn_j0, 0b00000000, 0b00000000, 0b11100000, 0b10000000

turn_l0         db  turn_l1, 0b00000000, 0b01100000, 0b01000000, 0b01000000 ; Фигура L
turn_l1         db  turn_l2, 0b00000000, 0b00000000, 0b10000000, 0b11100000
turn_l2         db  turn_l3, 0b00000000, 0b00100000, 0b00100000, 0b01100000
turn_l3         db  turn_l0, 0b00000000, 0b00000000, 0b11100000, 0b00100000
...
; После вывода на дисплей обновляем адрес данных о текущем повороте фигуры и переходим к следующему
; шагу
...
; Данные о каждой фигуре: адрес с данными о повороте и стартовое изображение
minos           db  0x00,    0b00001100, 0b00001100,    ; Фигура O
                    turn_i0, 0b00000000, 0b00011110,    ; Фигура I
                    turn_s0, 0b00001100, 0b00011000,    ; Фигура S
                    turn_z0, 0b00011000, 0b00001100,    ; Фигура Z
                    turn_t0, 0b00001000, 0b00011100,    ; Фигура T
                    turn_j0, 0b00010000, 0b00011100,    ; Фигура J
                    turn_l0, 0b00000100, 0b00011100     ; Фигура L
