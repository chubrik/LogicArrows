...
; ##################################################################################################
        ...
        ldi a, 0b00010100   ; Code to connect monochrome display and digital indicator
        st a, 0x3E          ; Connect output
        ldi b, 2            ; First prime number is 2
        ldi d, 0x41         ; Display pointer for the first number
        st b, 0x3A          ; Output the number to the digital indicator
...
prime:  ld d, last          ; Read the pointer to the last found prime number on the display
        ...
        st b, 0x3A          ; Output the new prime number to the digital indicator
