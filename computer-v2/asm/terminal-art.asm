...
; Data for stage 1
data1       db  0b10000000, 0b11000000, 0b11000000, 0b11000000, 0b10110000, 0b11111000, ; Row 1
...
terminal    db  0               ; The current address is connected to the terminal's graphics output
out         db  0b00000001      ; Output port, connect terminal
...
data2       db                                                  0b10000100, 0b11000100,
                ...
                0b11110111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11110111, ; Row 2
...
; Memory Bank #1: continuation of the "data2" area
data2b      db                          0b11111111, 0b11111111, 0b11111011, 0b11111000,
                ...
                0b00011111, 0b00011111, 0b00011111, 0b00011111, 0b00001111, 0b00011111, ; Row 3
                ...
                0b01111111, 0b11111111, 0b11111110, 0b11111110                          ; Row 4

; Memory Bank #2: data for stage 3.
; For optimization, the data is stored in reverse order.
