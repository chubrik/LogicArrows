...
## Keyboard
A full-format keyboard, similar to a real PC. It has Latin and Cyrillic layouts, single and
permanent upper case, and an indicator that suggests when the next character can be entered.
