...
запустить прямо в браузере: от вентилей и сумматоров до двух полноценных компьютеров с программами и
  ...
  <thead>
    <tr>
      <td valign="top" width="50%">
        ...
        <b>Проект-флагман.</b>
        Компьютер с собственным ассемблером, программами и играми: Тетрис, Жизнь, Змейка и др.
        Активно обсуждается и развивается в сообществе любителей Стрелочек.
      </td>
      <td valign="top">
