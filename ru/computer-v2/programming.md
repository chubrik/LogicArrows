...
---|---|---
nop | Ничего не делает, переходит к следующей инструкции | `nop`
...
test ***X*** | Обновляет флаги по значению | Z, S
...
### Таблица инструкций
Каждая инструкция имеет свой код (opcode). К примеру, `st a, d` имеет код `3C` (ряд, затем колонка).
<table>
  <thead>
    <tr>
      <th></th>
