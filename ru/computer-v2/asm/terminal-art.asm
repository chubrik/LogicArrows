...
; ##       Исходный код программы "Арт в терминале" для компьютера из логических стрелочек        ##
...
out         db  0b00000001              ; Порт вывода, подключён терминал
...
; Банк памяти № 1: продолжение области данных "data2"
...
; Банк памяти № 2: данные для стадии 3.
; Для оптимизации данные хранятся в обратном порядке.
