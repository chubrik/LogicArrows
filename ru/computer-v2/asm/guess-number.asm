...
; Начало игры. Выводим 0 на цифровой индикатор и приветственное сообщение в терминал. Затем
...
in_out      db  0b00001101          ; Порт ввода-вывода, подключены терминал и цифровой индикатор в
                                    ;   знаковом режиме
