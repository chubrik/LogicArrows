...
; ##       Исходный код программы "Пишущая машинка" для компьютера из логических стрелочек        ##
