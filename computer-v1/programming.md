...
j***F*** |Совершает переход, при условии что флаг ***F*** в состоянии 1 и используя следующий байт в RAM как адрес.
jn***F*** |Совершает переход, при условии что флаг ***F*** в состоянии 0 и используя следующий байт в RAM как адрес.
j***F*** ***X*** |Совершает переход, при условии что флаг ***F*** в состоянии 1 и используя регистр ***X*** как адрес.
jn***F*** ***X*** |Совершает переход, при условии что флаг ***F*** в состоянии 0 и используя регистр ***X*** как адрес.
