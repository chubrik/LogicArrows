...
Инструкции из этого набора производят вычисления на основе регистров и флагов. В таблице ниже
используются условные ***X*** и ***Y*** для обозначения любых регистров.
...
exp ***X*** | Делает все биты равными флагу `С` | Z, S
